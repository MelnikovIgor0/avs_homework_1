...
### Делаю прогон тестов для source_for_4 (тесты приложены в папке tests):
...
### Делаю прогон тестов для source_for_5 (тесты приложены в папке tests):
...
### Делаю прогон тестов для source_for_6 (тесты приложены в папке tests):
...
### Делаю прогон тестов для source_for_7 (тесты приложены в папке tests):
